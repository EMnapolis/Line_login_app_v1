...
if menu == "🖥 หน้าต่างทำงาน":
    ...
    if "user_id" in st.session_state:
        ...
        st.page_link("1_Call_Rec", label="🎙️ ระบบ Call Recording Upload")
        st.markdown("[🎙️ ระบบ Call Recording Upload](/1_Call_Recording_Upload)")
        st.markdown("""
        <a href="/1_Call_Recording_Upload">
            <button style='font-size:16px;padding:8px 16px;border-radius:8px;background-color:#4CAF50;color:white;border:none;'>
